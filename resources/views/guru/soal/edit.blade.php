    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <form method="POST" action="{{ route('guru.soal.update', [$bankSoal->id, $soal->id]) }}" class="p-5 space-y-6" x-data="{ tipe: '{{ $soal->tipe }}', jumlahPilihan: '{{ $soal->jumlah_pilihan ?: 5 }}' }">
                ...
                <div x-show="tipe === 'tf'" class="space-y-4">
                    ...
                    <div class="space-y-2 pt-4">
                        ...
                        <div class="flex gap-3">
                            <label class="flex-1">
                                <input type="radio" name="jawaban_benar_tf" value="a" class="hidden peer" :required="tipe === 'tf'" @change="updateJawaban('a')" {{ old('jawaban_benar', $soal->jawaban_benar) == 'a' ? 'checked' : '' }}>
                            ...
                            <label class="flex-1">
                                <input type="radio" name="jawaban_benar_tf" value="b" class="hidden peer" :required="tipe === 'tf'" @change="updateJawaban('b')" {{ old('jawaban_benar', $soal->jawaban_benar) == 'b' ? 'checked' : '' }}>
                ...
                <input type="hidden" name="jawaban_benar" id="jawaban_benar_hidden" value="{{ old('jawaban_benar', $soal->jawaban_benar) }}">
