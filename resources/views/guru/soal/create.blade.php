    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Tambah Soal Baru</h1>
                    <p class="text-gray-600 dark:text-gray-400 mb-6">Bank Soal: {{ $bankSoal->nama_bank }} ({{ $bankSoal->mataPelajaran->nama }})</p>
                    ...
                    <form action="{{ route('guru.soal.store', $bankSoal->id) }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea id="pertanyaan" name="pertanyaan" required rows="4"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white @error('pertanyaan') border-red-500 @enderror"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="pilihan_a" name="pilihan_a" value="{{ old('pilihan_a') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="pilihan_b" name="pilihan_b" value="{{ old('pilihan_b') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="pilihan_c" name="pilihan_c" value="{{ old('pilihan_c') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="pilihan_d" name="pilihan_d" value="{{ old('pilihan_d') }}" required
