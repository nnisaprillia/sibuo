                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.guru.update', $guru) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $guru->name) }}" class="mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-gray-900 dark:text-gray-100 dark:bg-gray-700" required>
                            @error('name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div class="mb-4">
                            <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Email</label>
                            <input type="email" name="email" id="email" value="{{ old('email', $guru->email) }}" class="mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-gray-900 dark:text-gray-100 dark:bg-gray-700" required>
                        ...
                        <div class="mb-4 relative">
                            ...
                            <input type="password" name="password" id="password" class="mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-gray-900 dark:text-gray-100 dark:bg-gray-700 pr-10">
                        ...
                        <div class="mb-4 relative">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation" class="mt-1 block w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-gray-900 dark:text-gray-100 dark:bg-gray-700 pr-10">
