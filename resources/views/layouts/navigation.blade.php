            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.penugasan-guru.index')" :active="request()->routeIs('admin.penugasan-guru.*')">
                            Penugasan Guru
                        </x-nav-link>
                    @elseif(Auth::user()->role === 'guru')
                        ...
                        <x-nav-link :href="route('guru.bank-soal.index')" :active="request()->routeIs('guru.bank-soal.*')">
                            Bank Soal
                        </x-nav-link>
                        {{-- <x-nav-link :href="route('guru.hasil-ujian.index')" :active="request()->routeIs('guru.hasil-ujian.*')">
                            Hasil Ujian
                        </x-nav-link> --}}
                    @elseif(Auth::user()->role === 'siswa')
                        <!-- Siswa Menu -->
                        <x-nav-link :href="route('siswa.ujian.index')" :active="request()->routeIs('siswa.ujian.*')">
                            Ujian
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.penugasan-guru.index')" :active="request()->routeIs('admin.penugasan-guru.*')">
                    Penugasan Guru
                </x-responsive-nav-link>
            @elseif(Auth::user()->role === 'guru')
                <!-- Guru Menu (Mobile) -->
                ...
                <x-responsive-nav-link :href="route('guru.bank-soal.index')" :active="request()->routeIs('guru.bank-soal.*')">
                    Bank Soal
                </x-responsive-nav-link>
                {{-- <x-responsive-nav-link :href="route('guru.hasil-ujian.index')" :active="request()->routeIs('guru.hasil-ujian.*')">
                    Hasil Ujian
                </x-responsive-nav-link> --}}
            @elseif(Auth::user()->role === 'siswa')
                <!-- Siswa Menu (Mobile) -->
                <x-responsive-nav-link :href="route('siswa.ujian.index')" :active="request()->routeIs('siswa.ujian.*')">
                    Ujian
                </x-responsive-nav-link>
            @endif
        </div>
